...
/* smartuition 2014-09-25 03:50*/
var appId="CorsIntegration";!function(){"use strict";function a(a){a.when("/createLogin",{templateUrl:"core/accounts/register/createAccount.html",controller:"CreateAccountController"}).when("/login",{templateUrl:"core/accounts/login/login.html",controller:"LoginController"}).when("/products",{templateUrl:"core/products/list/productsList.html",controller:"ProductsListController"}).when("/productDetails",{templateUrl:"core/products/detail/productDetails.html",controller:"ProductDetailsController"}).otherwise({redirectTo:"/login"})}function b(a){a.defaults.headers.post["Content-Type"]="application/x-www-form-urlencoded;charset=utf-8",a.defaults.transformRequest=[function(a){var b=function(a){var c,d,e,f,g,h,i,j="";for(c in a)if(d=a[c],d instanceof Array)for(i=0;i<d.length;++i)g=d[i],e=c+"["+i+"]",h={},h[e]=g,j+=b(h)+"&";else if(d instanceof Object)for(f in d)g=d[f],e=c+"["+f+"]",h={},h[e]=g,j+=b(h)+"&";else void 0!==d&&null!==d&&(j+=encodeURIComponent(c)+"="+encodeURIComponent(d)+"&");return j.length?j.substr(0,j.length-1):j};return angular.isObject(a)&&"[object File]"!==String(a)?b(a):a}]}angular.module("CorsIntegration.Services.Accounts",[]).config(b),angular.module("CorsIntegration.Controllers.Products",["CorsIntegration.Services.Accounts"]),angular.module("CorsIntegration.Controllers.Accounts",["CorsIntegration.Services.Accounts"]);var c=angular.module("CorsIntegration",["ngRoute","CorsIntegration.Controllers.Products","CorsIntegration.Controllers.Accounts","CorsIntegration.Services.Accounts"]).config(a);a.$inject=["$routeProvider"],b.$inject=["$httpProvider"],c.run(["$q","$rootScope",function(){}])}(),function(){"use strict";function a(a,b){var c=a;c.loginData={userName:"",password:""},c.loginUser=function(){b.loginUser(c.loginData).then(function(a){c.isLoggedIn=!0,c.userName=a.userName,c.bearerToken=a.access_token,console.log("loged in")},function(a,b){c.isLoggedIn=!1,console.log(b)})}}var b="LoginController";angular.module("CorsIntegration.Controllers.Accounts").controller(b,a),a.$inject=["$scope","LoginService"]}(),function(){"use strict";function a(a,b){var c=a;c.registerUserData={email:"",password:"",confirmPassword2:""},c.registerUser=function(){console.log("Llamo bien"),b.registerUser(c.registerUserData).then(function(){c.isRegistered=!0,console.log("User registered")},function(a,b){c.isRegistered=!1,console.log(a),console.log(b)})}}var b="CreateAccountController";angular.module("CorsIntegration.Controllers.Accounts").controller(b,a),a.$inject=["$scope","createAccountService"]}(),function(){"use strict";function a(a){var b=this;b.loginData={userName:"",password:""},b.loginUser=function(){a.loginUser(b.loginData).then(function(a){b.isLoggedIn=!0,b.userName=a.userName,b.bearerToken=a.access_token,console.log("loged in")},function(a,c){b.isLoggedIn=!1,console.log(c)})}}var b="ProductDetailsController";angular.module("CorsIntegration.Controllers.Products").controller(b,a),a.$inject=["productsService"]}(),function(){"use strict";function a(a){var b=this;b.loginData={userName:"",password:""},b.loginUser=function(){a.loginUser(b.loginData).then(function(a){b.isLoggedIn=!0,b.userName=a.userName,b.bearerToken=a.access_token,console.log("loged in")},function(a,c){b.isLoggedIn=!1,console.log(c)})}}var b="ProductsListController";angular.module("CorsIntegration.Controllers.Products").controller(b,a),a.$inject=["productsService"]}(),function(){"use strict";function a(a,b){function c(c){var d=g+"/Token";c.grant_type||(c.grant_type="password");var e=b.defer();return a({method:"POST",url:d,data:c}).success(function(a){h=a.access_token,console.log(a),e.resolve(a)}).error(function(a,b){console.log(a),e.reject(b)}),e.promise}function d(){var c=g+"/api/values/",d=b.defer();return a({method:"GET",url:c,headers:e()}).success(function(a){console.log(a),d.resolve(a)}).error(function(a,b){console.log(a),d.reject(b)}),d.promise}function e(){return h?{Authorization:"Bearer "+h}:{Authorization:"Bearer "+h}}var f={loginUser:c,getValues:d},g="http://localhost:57496",h="";return f}var b="LoginService";angular.module("CorsIntegration.Services.Accounts").factory(b,a),a.$inject=["$http","$q"]}(),function(){"use strict";function a(a,b){function c(c){var d=g+"/api/Account/Register",e=b.defer();return a({method:"POST",url:d,data:c}).success(function(a){console.log(a),e.resolve(a)}).error(function(a,b){console.log(a),e.reject(b)}),e.promise}function d(){var c=g+"/api/values/",d=b.defer();return a({method:"GET",url:c,headers:e()}).success(function(a){console.log(a),d.resolve(a)}).error(function(a,b){console.log(a),d.reject(b)}),d.promise}function e(){return h?{Authorization:"Bearer "+h}:{Authorization:"Bearer "+h}}var f={registerUser:c,getValues:d},g="http://localhost:57496",h="";return f}var b="createAccountService";angular.module("CorsIntegration.Services.Accounts").factory(b,a),a.$inject=["$http","$q"]}();